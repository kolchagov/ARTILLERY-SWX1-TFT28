...
void showInfoMessage(char *message) {
    GUI_Clear(infoSettings.bg_color);
    GUI_DispStringInRect(20, 0, LCD_WIDTH-20, LCD_HEIGHT, (uint8_t *)message);
    GUI_DispStringInRect(20, LCD_HEIGHT - (BYTE_HEIGHT*2), LCD_WIDTH-20, LCD_HEIGHT, (uint8_t *)"Wait a second...");
